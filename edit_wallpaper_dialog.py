...
class EditWallpaperDialog(QDialog):
    ...
    def application_edit_setup(self):
        ...
        self.application = QLabel(
            applicationValue if self.parent.isDefaultSetting else "Application:"
        )
    ...
    def handle_save(self):
        ...
        if not self.parent.isDefaultSetting:
            handleSaveArgs.extend(
                [self.applicationEdit.text(), self.processEdit.text()]
            )
